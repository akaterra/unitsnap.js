    ...
    it('should spy with mock or custom "call args" and "return value" value processors', () => {
      ...
      const customA = unitsnap.Custom((...args: any[]) => 1).argsAnnotation(['x', 'y', 'z'])
        .onCallArgs
          ...
          .addStrictInstanceOfProcessor(T, () => 'arg is cls T')
        ...
        .onReturnValue
          ...
          .addStrictInstanceOfProcessor(T, () => 'ret is cls T')
          // .addPathProcessor()
          // .addRegexPathProcessor()
      ...
      const mock = unitsnap.Mock(history)
        .onCallArgs
          ...
          .addStrictInstanceOfProcessor(T, () => 'arg is cls T (mock)')
        ...
        .onReturnValue
          ...
          .addStrictInstanceOfProcessor(T, () => 'ret is cls T (mock)')
          // .addPathProcessor()
          // .addRegexPathProcessor()
